...
namespace MooseXLSReports
{
    ...
    {
        private struct WorksheetStartingDates
        {
        ...
        {
            startingDates = new List<WorksheetStartingDates>
                            {
                                ...
                                new WorksheetStartingDates{SheetName = "July", StartingDate = DateTime.Parse("24/06/2013")},                       
                                new WorksheetStartingDates{SheetName = "August", StartingDate = DateTime.Parse("22/07/2013")},                        
                                new WorksheetStartingDates{SheetName = "September", StartingDate = DateTime.Parse("19/08/2013")},                        
                                new WorksheetStartingDates{SheetName = "October", StartingDate = DateTime.Parse("23/09/2013")},                        
                                new WorksheetStartingDates{SheetName = "November", StartingDate = DateTime.Parse("21/10/2013")},                        
                                new WorksheetStartingDates{SheetName = "December", StartingDate = DateTime.Parse("25/11/2013")}                        
                            };
